                    ...
                    <div class="card shadow-2-strong" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control form-control-lg" id="floatingInput" placeholder="name@example.com" name="nama">
                                <label for="floatingInput">Nama Pengeluaran</label>
                            </div>
                            <div class="form-floating mb-4">
                                <input type="number" min="1" class="form-control" id="floatingPassword" placeholder="Password" name="income">
